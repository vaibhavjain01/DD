...
public class _drrsCorbaStub extends org.omg.CORBA.portable.ObjectImpl implements drrs.drrsCorba
{
  ...
  /* Student */
  public void bookRoom (String studentId, int roomNumber, String date, String timeSlot, org.omg.CORBA.StringHolder rt)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                bookRoom (studentId, roomNumber, date, timeSlot, rt        );
            } finally {
                _releaseReply ($in);
            }
  } // bookRoom
